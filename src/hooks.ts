...
const FILE_EDIT_TOOLS = ["write", "file_write", "file_edit", "edit", "edit_file", "patch"];
...
export function createFileReadAfterHook(
  ...
  return async (input, output) => {
    ...
    if (!isFileReadTool(input.tool, input.args as Record<string, unknown> | undefined)) return;
